...
public sealed partial class CE14WorkbenchRequirementControl : Control
{
    ...
    public CE14WorkbenchRequirementControl()
    {
    ...
    public CE14WorkbenchRequirementControl(CE14WorkbenchCraftRequirement requirement) : this()
    {
