...
public sealed partial class CE14ReligionEntityWindow : DefaultWindow
{
    ...
    public CE14ReligionEntityWindow()
    {
        RobustXamlLoader.Load(this);
        IoCManager.InjectDependencies(this);

        Sawmill = _log.GetSawmill("CE14_religion_entity_window");
    }

    public void UpdateState(CE14ReligionEntityUiState state)
    {
    ...
    private string GetStatusText(CE14ReligionEntityUiState state)
    {
        var sb = new StringBuilder();
        sb.Append(Loc.GetString("CE14-god-ui-follower-percentage", ("count", state.FollowerPercentage * 100)) + "\n");
        sb.Append(Loc.GetString("CE14-god-ui-mana-percentage", ("count", state.ManaPercentage * 100)) + "\n");
        return sb.ToString();
    }
}
