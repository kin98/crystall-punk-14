...
public sealed partial class CE14ModularCraftStartPointComponent : Component
{
    /// <summary>
    /// Starting free slots
    /// </summary>
    [DataField]
    public List<ProtoId<CE14ModularCraftSlotPrototype>> StartSlots = new();

    /// <summary>
    /// Current free slots. May vary depending on the modules delivered
    /// </summary>
    [DataField]
    public List<ProtoId<CE14ModularCraftSlotPrototype>> FreeSlots = new();

    /// <summary>
    /// A list of all installed parts.
    /// </summary>
    [DataField, AutoNetworkedField]
    public List<ProtoId<CE14ModularCraftPartPrototype>> InstalledParts = new();
