...
public sealed partial class DungeonSystem : SharedDungeonSystem
{
    ...
    public const int CollisionMask = (int) CollisionGroup.AllMask; //CE14 replace to AllMask
    public const int CollisionLayer = (int) CollisionGroup.AllMask; //CE14 replace to AllMask
